//
//  IO.NonBlocking.Registration.Queue+Methods.swift
//  swift-io
//
...
extension IO.NonBlocking.Registration.Queue {
    ...
    public func enqueue(_ request: IO.NonBlocking.Registration.Request) {
    ...
    public func dequeue() -> IO.NonBlocking.Registration.Request? {
        state.withLock { state in
    ...
    public func dequeueAll() -> [IO.NonBlocking.Registration.Request] {
        state.withLock { state in
