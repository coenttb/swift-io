//
//  IO.NonBlocking.Registration.Reply.swift
//  swift-io
//
...
extension IO.NonBlocking.Registration {
    ...
    public struct Reply: Sendable {
        ...
        public let result: Result<Payload, IO.NonBlocking.Error>

        public init(id: ReplyID, result: Result<Payload, IO.NonBlocking.Error>) {
            self.id = id
            self.result = result
        }
    }
    ...
    public struct ReplyID: Hashable, Sendable {
    ...
    public enum Payload: Sendable, Equatable {
        ...
        case registered(IO.NonBlocking.ID)
